...
# Create a prod-deps stage for installing app dependencies defined in Composer.
...
# Create a dev-deps stage for installing app dependencies defined in Composer.
...
# Create a new stage as base for the application that contains the minimal
# runtime dependencies for the application. This often uses a different base
# image from the install or build stage where the necessary files are copied
# from the install stage.
#
# The example below uses the PHP Apache image as the foundation for running the app.
# By specifying the "8.0-apache" tag, it will also use whatever happens to be the
...
# Creates a production stage whit the production dependencies
...
# Creates a development stage whit the development dependencies
